export const Button = () => {
  return (
    ...
    <div className="flex items-center justify-center my-8">
      <div className="flex gap-6">
        <a href="https://discord.gg/7Wd83Au9mA" target="_blank">
          <button
            type="button"
            title="Registrarse para Online"
            className="rounded rounded-lg bg-[#231d33] px-10 py-2  font-kufam font-bold text-white text-white shadow-lg  shadow-gray-500/50 hover:bg-[#e199f5]"
          >
             Únete a Discord 👾 
          </button>
        </a>
